...
const albumswithartistsAPI_auto = {

    /** Gets all entries from 'albumswithartists' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/albumswithartists`, requestOptions);
        return response.data;
    },
};

export { albumswithartistsAPI_auto };